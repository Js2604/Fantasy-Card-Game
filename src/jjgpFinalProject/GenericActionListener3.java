...
public class GenericActionListener3 implements MouseListener {
	private String file;
	private int x;
	private Image zoom;
	...
	public GenericActionListener3(int ind/*String f, int x, int ind*/) throws IOException {
		this.ind=ind;
		/*
		file=f;
		this.x=x;
	...
	public void mouseClicked(MouseEvent e) {
		...
		check.add(GenericActionListener2.rand);
		int sub=0;
